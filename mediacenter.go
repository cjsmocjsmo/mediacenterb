...
func intMSMarvelHandler(w http.ResponseWriter, r *http.Request) {
...
func intAndorHandler(w http.ResponseWriter, r *http.Request) {
	...
	json.NewEncoder(w).Encode(&AndorMedia)
	count := len(AndorMedia)
	log.Printf("Sent %v files", count)
}

func intNightSkyHandler(w http.ResponseWriter, r *http.Request) {
	...
	json.NewEncoder(w).Encode(&NightSkyMedia)
	count := len(NightSkyMedia)
	log.Printf("Sent %v files", count)
}
